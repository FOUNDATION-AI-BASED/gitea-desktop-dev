...
export class SubmoduleDiff extends React.Component<ISubmoduleDiffProps> {
  ...
  private renderOpenSubmoduleAction() {
    ...
    return (
      <span>
        <SuggestedAction
          title="Open this submodule on Gitea Desktop"
          description="You can open this submodule on Gitea Desktop as a normal repository to manage and commit any changes in it."
