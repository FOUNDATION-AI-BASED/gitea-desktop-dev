...
> {
  ...
  public render() {
    return (
      <Dialog
        title={`Move ${getName()} to the Applications folder?`}
    ...
    return (
      <DialogFooter>
        <OkCancelButtonGroup
          ...
          okButtonTitle={`This will move ${getName()} to the Applications folder on your Mac and restart the app.`}
