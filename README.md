...
Gitea Desktop is an open-source [Electron](https://www.electronjs.org/)-based
Git client for [self-hosted Gitea](https://gitea.io/) instances. It is written in [TypeScript](https://www.typescriptlang.org) and
uses [React](https://reactjs.org/). Forked from [GitHub Desktop](https://desktop.github.com).
